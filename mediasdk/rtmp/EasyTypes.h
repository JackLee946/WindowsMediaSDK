/*
	Copyright (c) 2012-2014 EasyDarwin.ORG All rights reserved.
...
#define EASY_SDK_BITRATE_INFO_FLAG	0x00000080		/* 码率标志 */
...
typedef struct __EASY_AV_Frame
{
	...
	Easy_U32    u32AVFrameType;		/* 视频的类型，I帧或P帧； 音频帧编码类型：AAC G711A G711U G726 */
	Easy_U8     *pBuffer;			/* 数据 */
